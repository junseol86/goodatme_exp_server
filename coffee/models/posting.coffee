...
module.exports = {
  posting: sqlz.define 'posting', {
    ...
    rgn_sgg: {type: Sequelize.STRING, allowNull: false}
    rgn_emd: {type: Sequelize.STRING}
    rgn_ri: {type: Sequelize.STRING}
    shape: {type: Sequelize.STRING, allowNull: false}
    color_r: {type: Sequelize.INTEGER, allowNull: false}
    color_g: {type: Sequelize.INTEGER, allowNull: false}
    color_b: {type: Sequelize.INTEGER, allowNull: false}
